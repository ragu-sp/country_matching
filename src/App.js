      ...
      <div id="serch_box" className="container">
        <div className="input-group">
          ...
          <div className="input-group-btn">
            <button onClick={() => $obj.Find_country()} className="btn btn-primary search_btn" type="submit"><i className="fa fa-search" ></i> SEARCH</button>
          </div>
        </div>
      </div>   
    )
        ...
        <table id="countries_table" className="table table-bordered">
          ...
          <tbody>
          {
                props.countries.map(country => {
                  return(
                    <tr key={props.countries.indexOf(country)+2}>
                              <td key={props.countries.indexOf(country)+1}>{props.countries.indexOf(country)+1}</td>
                              <td key={
                              ...
                              <td key={country.probability}>{country.probability}</td>
                    </tr>
                  );
                })
              }
